  ...
  <body>
    ...
    <header>
        ...
        <nav>
            ...
            <button class="tab-button" onclick="openTab(event, 'przejazdy')">Przejazdy</button>
        </nav>
    </header>

    <main>
        <div id="pulpit" class="tab-content">
            <h2>Pulpit i Ewidencja Czasu Pracy</h2>
            <div id="kalendarz-podsumowanie" class="summary-container-subtle"></div>
            <div id="kalendarz" class="calendar-container"></div>
        </div>
        ...
        <div id="zlecenia" class="tab-content">
            ...
            <div class="table-section">
                ...
                <div class="summary-controls"><label for="miesiac-summary">Podsumowanie dla miesiąca:</label><input type="month" id="miesiac-summary"><button id="export-zlecenia-btn" class="btn-edit">Eksportuj</button></div>
                <div id="summary-container"></div><div id="ukonczone-zlecenia-lista"></div>
            </div>
        </div>
        ...
        <div id="przejazdy" class="tab-content">
            <h2>Ewidencja Przejazdów</h2>
            <div class="form-section">
                <h3>Dodaj lub edytuj przejazd</h3>
                <form id="przejazd-form"><div class="form-group"><label for="data">Data:</label><input type="date" id="data" required></div><div class="form-group"><label for="skad">Skąd:</label><input type="text" id="skad" placeholder="Np. Baza" required></div><div class="form-group"><label for="dokad">Dokąd:</label><input type="text" id="dokad" placeholder="Np. Klient A" required></div><div class="form-group"><label for="dystans">Dystans (km):</label><input type="number" id="dystans" placeholder="Np. 50" required></div><button type="submit">Zapisz Przejazd</button></form>
            </div>
            <div class="summary-controls">
                <h3>Zapisane Przejazdy</h3><label for="miesiac-przejazdy">Miesiąc:</label><input type="month" id="miesiac-przejazdy"><button id="export-przejazdy-btn" class="btn-edit">Eksportuj</button>
            </div>
            <div id="lista-przejazdow"><p>Ładowanie...</p></div>
        </div>
    </main>
